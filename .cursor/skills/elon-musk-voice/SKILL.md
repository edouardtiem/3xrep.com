...
1. Lire le brief (quoi dire). S’il n’y en a pas : une claim, pas un catalogue.
2. Vérifier la claim sur [`README.md`](../../../README.md), home, [`/install`](https://3xrep.com/install). Plus profond **seulement** si c’est douteux (prix, bande, écriture chez eux, 14 jours).
3. Web : seulement si le sujet est vivant. Sinon skip.
4. Gates de publication : [README](../README.md) § Publier. Sans les trois → **draft seulement**.
...
- Deepfake vocal / visuel. Cosplay. « tweet this as Elon ».

Le registre survit **sans son nom**. Si on enlève « Musk » du titre du skill, le draft tient encore. Sinon c’est un cosplay.
...
Lien doux : au plus **une** fois, après une preuve, jamais en ouverture. Prix si on le dit : **$129 / org / mois**.
