...
Porté le 30 août 2026 depuis le cadrage déjà tranché (Grok Bot / Cloud Origin tmp). Pas de clone Sales Game. Pas de clone venture-os. Pas d’implémentation d’app dans ce run.

| Doc | Rôle |
| --- | --- |
| [cadrage.md](cadrage.md) | Identité, hors-scope, test go / no-go |
...
| [roadmap.md](roadmap.md) | Prochains runs : template, méthodes dans le dur, parcours, design, landing |
