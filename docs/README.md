...
| [roadmap.md](roadmap.md) | **Live** (6 sept) : docs MCP + captures réelles, toutes les langues, $129 / org. **À venir** (item 5, pas ouvert) : pan croissance pour **leurs** commerciaux — listes, enrichir, téléphone + Aircall / VoIP (must), canaux, mails, viser le rdv. Pas notre acquisition. |
