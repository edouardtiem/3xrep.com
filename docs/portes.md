...
Prix (page Slack, capture 6 sept) : add-on **125 $ / siège / mois** (Enterprise / Unlimited) **ou** Edition Agentforce 1 Sales **550 $ / siège / mois** (agents + Data 360 + Slack + Tableau). Aussi un modèle crédits. Per-seat. L’ancre inverse de nous (129 dollars / org, pas de siège).
...
Ancre prix utile : eux vendent **125 $ / siège** (Salesforce) pour écrire et synchroniser. Nous : 129 dollars / organisation pour dire que l’étape ment. Ne pas ouvrir une guerre de sièges. L’écart se dit : pas de siège, pas d’enregistrement, pas de stylo dans leur fichier.
