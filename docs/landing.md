...
« Don’t store » retiré le 6 sept 2026 : on log les bodies des tool calls 14 jours ([`mcp_calls`](../supabase/migrations/20260906160000_mcp_calls.sql)), puis delete. On n’enregistre toujours pas les calls (pas de bot Zoom). On n’écrit pas dans leur CRM.
