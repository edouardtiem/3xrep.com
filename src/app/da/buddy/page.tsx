...
export const metadata: Metadata = {
  title: "3xrep — your sales buddy",
  description: "Your sales day, figured out. Know what to do next on the deal, with a sales buddy inside your AI chat.",
...
export default function BuddyStudy() {
  return (
    <div className={styles.page}>
      <Header />
      <main id="main-content" className={styles.main}>
        <p className={styles.study}>Design preview · sales buddy</p>
