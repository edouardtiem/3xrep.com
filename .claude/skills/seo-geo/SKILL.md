...
3. **Dernières captures** — `docs/visibility/captures/` si le dossier existe. Le check [`ai-search-visibility`](../../../.agents/skills/ai-search-visibility/SKILL.md) peut aussi avoir ajouté au bus.
