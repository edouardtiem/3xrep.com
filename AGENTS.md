...
- Prix encaissable : **129 dollars / mois / organisation**. Stripe USD. [checkout.md](docs/checkout.md). Tools encore ouverts (pas de mur).

**Direction, pas ship** : [portes.md](docs/portes.md) — un visage par travail, Slack plus tard. Une base à nous = demain, pas un fichier client sans fenêtre. **14 sept** : squelette sans fin, essai qui coupe, parrainage, profil au premier branchement — [decisions.md](docs/decisions.md), [plg.md](docs/plg.md), [roadmap.md](docs/roadmap.md) item 6.
